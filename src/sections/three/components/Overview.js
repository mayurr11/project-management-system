...
// //     const updatedGoals = goals.map((goal, i) => (i === index ? { ...goal, text } : goal));
// //     setGoals(updatedGoals);
// //   };

// //   const addPortfolioItem = () => {
// //     setPortfolioItems([...portfolioItems, { name: '', description: '', link: '' }]);
// //   };
...
// //     const updatedResources = keyResources.map((resource, i) =>
// //       i === index ? { ...resource, files: [...resource.files, ...files] } : resource
// //     );
// //     setKeyResources(updatedResources);
// //   };
...
// //               <p>Connect or create a goal to link this project to a larger purpose.</p>
// //               <button
// //                 type="button"
// //                 onClick={addGoal}
// //                 onKeyDown={(e) => {
...
// //           <div className="block-container">
// //             <div className="block-left-section">
// //               <img src={portfolioLogo} alt="portfolio logo" className="block-logo" />
// //             </div>
// //             <div className="block-right-section">
// //               <p>Connect a portfolio to link this project to a larger body of work.</p>
// //               <button
// //                 type="button"
...
// //           <div className="block-container">
// //             <div className="block-left-section">
// //               <img src={resourcesLogo} alt="resources logo" className="block-logo" />
// //             </div>
// //             <div className="block-right-section">
// //               <p>
// //                 Align your team around a shared vision with a project brief and supporting
// //                 resources.
// //               </p>
